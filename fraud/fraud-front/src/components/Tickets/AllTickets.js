...
class AllTickets extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            etat: '',
            contenu: '',
            reponse: 'Aucune réponse pour le moment',
            addresponse: '',
        }
    }
    ...
    IsAdmin = () => {
        if (isLoginAdmin) {
            return ( <
                ...
                <
                label
                for = 'content' > Ajouter un commentaire / une réponse < /label> <
            ...
            return ( <
                ...
                style = {
                    { fontSize: 16, fontWeight: "bold", textAlign: "center" } } > Reponse < /Box> <
                Box style = {
                    { marginTop: 8 } } > { this.state.reponse } < /Box> <
                /Box> <
                button style = {
                    { marginLeft: 10 } }
                onClick = {
    ...
    contentModal = () => {
        return ( <
            ...
            <
            div style = {
                { backgroundColor: "black", height: 30, margin: 20 } } >

            <
            h5 style = {
                { textAlign: "center", paddingTop: 5, color: 'white' } } > { this.state.title } < /h5> <
            /div> <
            div style = {
                { width: '100%' } } >
            ...
            <
            Box style = {
                { textAlign: 'center', color: 'black', fontWeight: 'bold', fontSize: 16 } } > service < /Box> <
            Box style = {
                { textAlign: "center" } } > { this.state.service } < /Box> <
            /Box> <
            Box p = { 1 }
            bgcolor = "grey.300" >
            <
            Box style = {
                { textAlign: 'center', color: 'black', fontWeight: 'bold', fontSize: 16 } } > auteur < /Box> <
            Box style = {
                { textAlign: "center" } } > { this.state.auteur } < /Box> <
            /Box> <
            Box p = { 1 }
            bgcolor = "grey.300" >
            <
            Box style = {
                { textAlign: 'center', color: 'black', fontWeight: 'bold', fontSize: 16 } } > date de création < /Box> <
            Box style = {
                { textAlign: "center" } } > { this.state.date } < /Box> <
            /Box>
            ...
            Box bgcolor = "grey.300"
            style = {
                { fontSize: 16, fontWeight: "bold", textAlign: "center" } } > details < /Box> <
            Box style = {
                { marginTop: 8 } } > { this.state.contenu } < /Box> <
            /Box> <
            /div>
